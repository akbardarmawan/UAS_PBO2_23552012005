...
public class admin_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Masukkan Username dan Password Admin");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("select * from tbl_admin where admin_username='" + txt_username.getText() + "' and admin_password = '" + txt_password.getText() + "'");
            if (sql.next()) {
                if (txt_password.getText().equals(sql.getString("admin_password"))) {
